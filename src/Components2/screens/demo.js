// import Demo1 from "./axiosdemo.js";
...
const Card = ({ number, details, imageSrc, alignLeft, isOpen, onToggle }) => {
    return (
        <div
...
const Scroll = () => {
    ...
    const [cards, setCards] = useState([
        {
            id: 1, number: 1, details: dummy, imageSrc: 'https://images.pexels.com/photos/13332170/pexels-photo-13332170.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500', alignLeft: true, isOpen: false
        },
        { id: 2, number: 2, details: dummy, imageSrc: 'https://images.pexels.com/photos/13332170/pexels-photo-13332170.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500', alignLeft: false, isOpen: false },
